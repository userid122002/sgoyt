...
export const query = graphql`
  query {
    ...
    gl_285399: allGameDataJson (limit: 25, sort: {fields: sgoyt_count_285399, order: DESC}, filter: {sgoyt_count_285399: {gt: 0}}) {
      nodes {
        game_id
        game_name
        bgg_link
    ...
    gl_286889: allGameDataJson (limit: 25, sort: {fields: sgoyt_count_286889, order: DESC}, filter: {sgoyt_count_286889: {gt: 0}}) {
      nodes {
        game_id
        game_name
        bgg_link
