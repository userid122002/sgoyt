...
export default function MechanicsIndexGrid( {data} ) {
    const columns = [
        ...
        { field: 'mechanics', headerName: 'Mechanics', width: 1500 },
    ...
    return (
        <div>
            <p><small>The column header can be used to filter the results for a particular game or mechanic.</small></p>
            <p><small>Note: You will need to scroll over to the right and hover over the menu in order to see the option to filter by mechanic.</small></p>
